    ...
    chartData = [
        {
            ...
            series: [
                ...
                {x: new Date('2007-05-11'), y: 108.74},
                {x: new Date('2007-05-14'), y: 109.36},
                {x: new Date('2007-05-15'), y: 107.52},
                {x: new Date('2007-05-16'), y: 107.34},
                {x: new Date('2007-05-17'), y: 109.44},
                {x: new Date('2007-05-18'), y: 110.02},
                {x: new Date('2007-05-19'), y: 111.98},
                {x: new Date('2007-05-22'), y: 113.54},
                {x: new Date('2007-05-23'), y: 112.89},
                {x: new Date('2007-05-24'), y: 110.69},
                {x: new Date('2007-05-25'), y: 113.62},
                {x: new Date('2007-05-29'), y: 114.35},
                {x: new Date('2007-05-30'), y: 118.77},
                {x: new Date('2007-05-31'), y: 121.19},
                {x: new Date('2007-06-01'), y: 118.40},
                {x: new Date('2007-06-04'), y: 121.33},
                {x: new Date('2007-06-07'), y: 122.67}
            ]
        },
        {
            name: 'Second Series',
